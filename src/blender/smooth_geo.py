...
if __name__ == "__main__":
    ...
    parser.add_argument('-wn', type=float, default=0.1, help="butterdingens")
    ...
    inner_geo, smooth_outer_geo=smooth_geo(geo, resolution=args.resolution, thickness=args.thickness, Wn=args.wn)
    geos={
        "inner": inner_geo,
