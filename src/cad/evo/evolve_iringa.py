# mbeya has a ground tone in a and a first toot also in a
...
try:
    ...
    class IringaLoss(LossFunction):
        ...
        def __init__(self, target_balance):
            ...
            self.tuning_helper=TootTuningHelper([0,2,3,7,9,10], -26)
            self.target_balance=target_balance

        def get_loss(self, geo, context=None):

            fundamental=single_note_loss(-26, geo)*4
            octave=single_note_loss(-14, geo, i_note=1)
