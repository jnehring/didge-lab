...
## Standing on the shoulders of giants. Related works

DidgeLab is built on other works:
...
* The acoustic simulation of the didgeridoo is based on transmission line modeling [Dan Mapes-Riordan, 1991: Horn Modeling with Conical and Cylindrical Transmission Line Elements
...
## What can it do? Where are practical examples?
